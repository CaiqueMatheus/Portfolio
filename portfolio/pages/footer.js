...
export default function footer() {
    return (
        <Navbar color="light" expand="md" fixed="bottom">
                ...
                <FontAwesomeIcon className={styles.icons} icon={faFacebookSquare} size="lg" />
                <FontAwesomeIcon className={styles.icons} icon={faInstagramSquare} size="lg" />
                <FontAwesomeIcon className={styles.icons} icon={faLinkedin} size="lg"/>
                <FontAwesomeIcon className={styles.icons} icon={faBehanceSquare} size="lg" />
